...
% GUI_PROJEKTARBEIT MATLAB code for gui_Projektarbeit.fig
...
%
%      GUI_PROJEKTARBEIT('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GUI_PROJEKTARBEIT.M with the given input arguments.
%
%      GUI_PROJEKTARBEIT('Property','Value',...) creates a new GUI_PROJEKTARBEIT or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before gui_Projektarbeit_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to gui_Projektarbeit_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 04-Nov-2016 10:53:57
...
% varargin   command line arguments to gui_Projektarbeit (see VARARGIN)

% Bild Übertragungsfunktion_Strecke einfügen


axes(handles.axes2);
G1=imread('C:\Users\David\Studium\Master\Projektarbeit\UebertragungsfunktionStrecke','png');   % Einlesen der Grafik 
...
function edit_zeitkonstanteT_Callback(hObject, eventdata, handles)
% hObject    handle to edit_zeitkonstanteT (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_zeitkonstanteT as text
%        str2double(get(hObject,'String')) returns contents of edit_zeitkonstanteT as a double

% T einlesen
zeitkonstanteT = str2double(get(hObject,'String'));
handles.zeitkonstanteT = zeitkonstanteT;
...
% --- Executes during object creation, after setting all properties.
function edit_zeitkonstanteT_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_zeitkonstanteT (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function edit_daempfungD_Callback(hObject, eventdata, handles)
% hObject    handle to edit_daempfungD (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of edit_daempfungD as text
%        str2double(get(hObject,'String')) returns contents of edit_daempfungD as a double

% D einlesen
daempfungD = str2double(get(hObject,'String'));
handles.daempfungD = daempfungD;

% TO DO ERROR HANDLING nur NUmmern dürfen eingegebene werden
...
% --- Executes during object creation, after setting all properties.
function edit_daempfungD_CreateFcn(hObject, eventdata, handles)
% hObject    handle to edit_daempfungD (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
% Wenn kein EIntrag in handles existiert zu K,T,D dann POPUPFENSTER öffnen
% mit FEHLERMELDUNG


% Zuweisung der Parameter aus der struct handles
konstanteK = handles.konstanteK;
zeitkonstanteT = handles.zeitkonstanteT;
daempfungD = handles.daempfungD;

% Call der Funktion Bestimmung_Wendetangente
[Tu,Ta] = Bestimmung_Wendetangente(konstanteK,zeitkonstanteT,daempfungD);
...
GsDenominator = [zeitkonstanteT^2 2*daempfungD*zeitkonstanteT 1];
